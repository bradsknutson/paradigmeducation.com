<?php
/**
 * Template Name: Template 2: Alternating Content
 *
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			while ( have_posts() ) : the_post();
				...
				get_template_part( 'template-parts/content', 'product-info-sub' );
				get_template_part( 'template-parts/content', 'alternating-text-images' );
				get_template_part( 'template-parts/content', 'new-releases-specific' );
