                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="blog-categories">
                                <?php
                                    ...
                                    echo '<div class="col-md-4"><a class="category-button'. $view_all .'" href="'. get_permalink($blog_id) .'">View All</a></div>';
                                
                                    if ( ! empty( $categories ) ) {
                                        foreach ( $categories as $category ) {
                                            echo '<div class="col-md-4"><a class="category-button" href="'. get_category_link( $category->term_id ) .'">'. $category->name .'</a></div>';
                                        }
                                    }
